...
import org.openqa.selenium.support.ui.WebDriverWait;
 ...
 public class BasePageFactory {
	...
	protected String getSourceCode(WebDriver driver) {
	...
	protected void switchToWindowTitle(WebDriver driver, String expectedPageTitle) {
		Set<String> allWindowIDs = driver.getWindowHandles();
		for (String id : allWindowIDs) {
			driver.switchTo().window(id);
	...
	protected void selectItemCustomDropdown(WebDriver driver, String parentLocator, String childLocator, String expectedTextItem) {
		getWebElement(driver, parentLocator).click();
		sleepInSecond(3);
		
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
		List<WebElement> allDropdownItems = explicitWait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(getByXpath(childLocator)));
	...
	protected String getElementAtribute(WebDriver driver, String xpathLocator, String attributeName) {
	...
	protected void waitForAllInElementVisible(WebDriver driver, List<WebElement> elements) {
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
